...
const config = {
  ...
  /**
   * *If you need to delete slash commands, enter the slash command id into the property below, or if you want to delete all slash commands then use the boolean: true
   */
